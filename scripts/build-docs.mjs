...
function navbar(activeOut) {
    const links = [
        `<a class="brand" href="index.html">NomNomytics · Docs</a>`,
        ...PAGES.map(
            (page) =>
...
<title>${escapeHtml(title)} — NomNomytics</title>
...
<p>NomNomytics is a multi-institution SaaS for tracking shared meals,
...
writeFileSync(
    ...
    shell({
        out: 'index.html',
        title: 'Documentation',
        blurb: 'Human-readable docs for the NomNomytics platform.',
        body: indexBody.trim(),
    }),
    'utf8'
);
